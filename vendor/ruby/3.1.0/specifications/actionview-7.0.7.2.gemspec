# -*- encoding: utf-8 -*-
# stub: actionview 7.0.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<actionpack>.freeze, ["= 7.0.7.2"])
    s.add_development_dependency(%q<activemodel>.freeze, ["= 7.0.7.2"])
  else
