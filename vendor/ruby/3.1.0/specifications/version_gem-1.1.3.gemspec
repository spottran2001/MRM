# -*- encoding: utf-8 -*-
# stub: version_gem 1.1.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://gitlab.com/oauth-xx/version_gem/-/issues", "changelog_uri" => "https://gitlab.com/oauth-xx/version_gem/-/blob/v1.1.3/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/version_gem/1.1.3", "funding_uri" => "https://liberapay.com/pboling", "homepage_uri" => "https://gitlab.com/oauth-xx/version_gem", "mailing_list_uri" => "https://groups.google.com/g/oauth-ruby", "rubygems_mfa_required" => "true", "source_code_uri" => "https://gitlab.com/oauth-xx/version_gem/-/tree/v1.1.3", "wiki_uri" => "https://gitlab.com/oauth-xx/version_gem/-/wiki" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rspec-block_is_expected>.freeze, ["~> 1.0"])
    s.add_development_dependency(%q<rake>.freeze, ["~> 13.0"])
    s.add_development_dependency(%q<pry>.freeze, ["~> 0.14"])
  else
    s.add_dependency(%q<rspec>.freeze, ["~> 3.12"])
    s.add_dependency(%q<rspec-block_is_expected>.freeze, ["~> 1.0"])
