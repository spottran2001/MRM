# -*- encoding: utf-8 -*-
# stub: railties 7.0.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<actionview>.freeze, ["= 7.0.7.2"])
  else
